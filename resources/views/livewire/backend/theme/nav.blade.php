        ...
        <ul class="main-nav p-0 mt-2">
            ...
            <li>
                <a aria-expanded="false" data-bs-toggle="collapse" href="#ui-kits">
                    <svg stroke="currentColor" stroke-width="1.5">
                        <use xlink:href="{{ url('assets/backend/svg/_sprite.svg#briefcase') }}"></use>
                    </svg>
                    UI kits
                </a>
            ...
            <li>
                <a aria-expanded="false" data-bs-toggle="collapse" href="#advance-ui">
                    <svg stroke="currentColor" stroke-width="1.5">
                        <use xlink:href="{{ url('assets/backend/svg/_sprite.svg#briefcase-advance') }}"></use>
                    </svg>
                    Advance UI
            ...
            <li>
                <a aria-expanded="false" data-bs-toggle="collapse" href="#icons">
                    <svg stroke="currentColor" stroke-width="1.5">
                        <use xlink:href="{{ url('assets/backend/svg/_sprite.svg#gift') }}"></use>
                    </svg>
                    Icons
                </a>
            ...
            <li class="no-sub">
                <a href="misc.html">
                    ...
                    <svg stroke="currentColor" stroke-width="1.5">
                        <use xlink:href="{{ url('assets/backend/svg/_sprite.svg#rectangle') }}"></use>
                    </svg>
                    Misc
                </a>
            </li>
            ...
            <li>
                <a aria-expanded="false" data-bs-toggle="collapse" href="#maps">
                    <svg stroke="currentColor" stroke-width="1.5">
                        <use xlink:href="{{ url('assets/backend/svg/_sprite.svg#location') }}"></use>
                    </svg>
                    Map
                </a>
            ...
            <li>
                <a aria-expanded="false" data-bs-toggle="collapse" href="#chart">
                    <svg stroke="currentColor" stroke-width="1.5">
                        <use xlink:href="{{ url('assets/backend/svg/_sprite.svg#chart') }}"></use>
                    </svg>
                    Chart
                </a>
            ...
            <li>
                <a aria-expanded="false" data-bs-toggle="collapse" href="#table">
                    <svg stroke="currentColor" stroke-width="1.5">
                        <use xlink:href="{{ url('assets/backend/svg/_sprite.svg#table') }}"></use>
                    </svg>
                    Table
                </a>
            ...
            <li>
                <a aria-expanded="false" data-bs-toggle="collapse" href="#forms">
                    <svg stroke="currentColor" stroke-width="1.5">
                        <use xlink:href="{{ url('assets/backend/svg/_sprite.svg#wallet') }}"></use>
                    </svg>
                    Forms elements
                </a>
            ...
            <li>
                <a aria-expanded="false" data-bs-toggle="collapse" href="#ready_to_use">
                    <svg stroke="currentColor" stroke-width="1.5">
                        <use xlink:href="{{ url('assets/backend/svg/_sprite.svg#newspaper') }}"></use>
                    </svg>
                    Ready to use
            ...
            <li>
                <a aria-expanded="false" data-bs-toggle="collapse" href="#auth_pages">
                    <svg stroke="currentColor" stroke-width="1.5">
                        <use xlink:href="{{ url('assets/backend/svg/_sprite.svg#window') }}"></use>
                    </svg>
                    Auth Pages
                </a>
            ...
            <li>
                <a aria-expanded="false" data-bs-toggle="collapse" href="#error_pages">
                    <svg stroke="currentColor" stroke-width="1.5">
                        <use xlink:href="{{ url('assets/backend/svg/_sprite.svg#exclamation-circle') }}"></use>
                    </svg>
                    Error Pages
                </a>
            ...
            <li>
                <a aria-expanded="false" data-bs-toggle="collapse" href="#other_pages">
                    <svg stroke="currentColor" stroke-width="1.5">
                        <use xlink:href="{{ url('assets/backend/svg/_sprite.svg#document') }}"></use>
                    </svg>
                    Other Pages
                </a>
            ...
            <li>
                <a aria-expanded="false" data-bs-toggle="collapse" href="#level">
                    <svg stroke="currentColor" stroke-width="1.5">
                        <use xlink:href="{{ url('assets/backend/svg/_sprite.svg#arrow-down') }}"></use>
                    </svg>
                    2 level
                </a>
            ...
            <li class="no-sub">
                <a href="https://phpstack-1384472-5121645.cloudwaysapps.com/document/html/ki-admin/index.html">
                    <svg stroke="currentColor" stroke-width="1.5">
                        <use xlink:href="{{ url('assets/backend/svg/_sprite.svg#document-text') }}"></use>
                    </svg>
                    Document
                </a>
            </li>
            ...
            <li class="no-sub">
                <a href="mailto:teqlathemes@gmail.com">
                    <svg stroke="currentColor" stroke-width="1.5">
                        <use xlink:href="{{ url('assets/backend/svg/_sprite.svg#chat-bubble') }}"></use>
                    </svg>
                    Support
                </a>
            </li>
