                            ...
                            <div class="offcanvas-body app-scroll p-0">
                                <div class="head-container">
                                    <div class="head-box">
                                        <span class="b-1-light bg-light-primary h-45 w-45 d-flex-center b-r-6">
                                            <img alt="cart" class="img-fluid p-1"
                                                src="{{ url('assets/backend/images/header/cart/01.png') }}">
                                        </span>
                                    ...
                                    <div class="head-box">
                                        <span class="b-1-light bg-light-primary h-45 w-45 d-flex-center b-r-6">
                                            <img alt="cart" class="img-fluid p-1"
                                                src="{{ url('assets/backend/images/header/cart/05.png') }}">
                                        </span>
                                        <div class="flex-grow-1 ms-2">
                                            <a class="mb-0 f-w-600 f-s-16" href="product_details.html"
                                                target="_blank"> Womens Watch (4<i
                                    ...
                                    <div class="head-box">
                                        <span class="b-1-light bg-light-primary h-45 w-45 d-flex-center b-r-6">
                                            <img alt="cart" class="img-fluid p-1"
                                                src="{{ url('assets/backend/images/header/cart/04.png') }}">
                                        </span>
                                        <div class="flex-grow-1 ms-2">
                                            <a class="mb-0 f-w-600 f-s-16" href="product_details.html"
                                    ...
                                    <div class="head-box ">
                                        <span class="b-1-light bg-light-primary h-45 w-45 d-flex-center b-r-6">
                                            <img alt="cart" class="img-fluid p-1"
                                                src="{{ url('assets/backend/images/header/cart/03.png') }}">
                                        </span>
                                        <div class="flex-grow-1 ms-2">
                                            <a class="mb-0 f-w-600 f-s-16" href="product_details.html"
                                    ...
                                    <div class="head-box ">
                                        <span class="b-1-light bg-light-primary h-45 w-45 d-flex-center b-r-6">
                                            <img alt="cart" class="img-fluid p-1"
                                                src="{{ url('assets/backend/images/header/cart/02.png') }}">
                                        </span>
                                        <div class="flex-grow-1 ms-2">
                                            <a class="mb-0 f-w-600 f-s-16" href="product_details.html"
